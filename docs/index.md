# Welcome to AeroCM Documentation !
...
This package is used in particular within [AeroMAPS](https://github.com/AeroMAPS/AeroMAPS), an open-source framework for performing Multidisciplinary Assessment of Prospective Scenarios for air transport. 
