...
class FairRunner:
    ...
    def _setup_model(self):
        ...
        fill(
            f.climate_configs["ocean_heat_transfer"], [1.3, 1.6, 0.6], config="central"
        )
        ...
        concentration_data_path = pth.join(
            concentration.__path__[0], "concentration_data.csv"
        )
        ...
        fill(
            f.species_configs["baseline_concentration"], co2_concentration, specie="CO2"
        )
        fill(
